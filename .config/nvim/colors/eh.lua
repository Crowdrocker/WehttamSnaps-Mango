...
if not present or not (base46._EH_SUPPORT or base46._EH_SUPPORT) then
	vim.notify(
		"base46 plugin not found or incorrect, make sure to install Mattscreative/base46",
...
if not base46.theme_tables[theme_name] or base46.theme_tables[theme_name].type ~= vim.o.background then
	...
	local harmonized = base46.theme_harmonize(builtin, "#e021a1", harmony)
	harmonized = base46.theme_set_bg(harmonized, "#181115")
