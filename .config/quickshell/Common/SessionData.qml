...
Singleton {
    ...
    property int wallpaperLastPage: 0
    property string wallpaperSortMode: "name"
    property int galleryColumns: 6
    property int galleryRows: 10
    property real galleryScale: 2.0
    property int galleryThumbnailRadius: 3
    ...
    property int wallpaperTransitionDuration: 2000
    property bool useAwwwBackend: false
    property string wallpaperFillMode: "crop"

    // BingWallpaper settings
    property bool bingWallpaperEnabled: false
    property bool bingWallpaperNotifications: true
    property bool bingWallpaperDeleteOld: true
    property bool bingWallpaperDailyRefresh: false
    property string bingWallpaperDailyRefreshTime: "09:00"
    property string bingWallpaperCurrentImagePath: ""
    property bool bingWallpaperForceRefresh: false
    property string bingWallpaperForceRefreshTime: "09:00"
    property string bingWallpaperGalleryPath: ""
    property bool bingDailyWallpaperEnabled: false
    ...
    // Interactive timeout enabled - when disabled, prevents monitor/timeouts
    property bool interactiveTimeoutEnabled: true
    ...
    function parseSettings(content) {
        try {
            if (content && content.trim()) {
                ...
                wallpaperLastPage = settings.wallpaperLastPage !== undefined ? settings.wallpaperLastPage : 0
                wallpaperSortMode = settings.wallpaperSortMode !== undefined ? settings.wallpaperSortMode : "name"
                galleryColumns = settings.galleryColumns !== undefined ? settings.galleryColumns : 6
                galleryRows = settings.galleryRows !== undefined ? settings.galleryRows : 10
                galleryScale = settings.galleryScale !== undefined ? settings.galleryScale : 2.0
                galleryThumbnailRadius = settings.galleryThumbnailRadius !== undefined ? settings.galleryThumbnailRadius : 3
                ...
                wallpaperTransitionDuration = settings.wallpaperTransitionDuration !== undefined ? settings.wallpaperTransitionDuration : 2000
                ...
                // BingWallpaper settings
                bingWallpaperEnabled = settings.bingWallpaperEnabled !== undefined ? settings.bingWallpaperEnabled : false
                bingWallpaperNotifications = settings.bingWallpaperNotifications !== undefined ? settings.bingWallpaperNotifications : true
                bingWallpaperDeleteOld = settings.bingWallpaperDeleteOld !== undefined ? settings.bingWallpaperDeleteOld : true
                bingWallpaperDailyRefresh = settings.bingWallpaperDailyRefresh !== undefined ? settings.bingWallpaperDailyRefresh : false
                bingWallpaperDailyRefreshTime = settings.bingWallpaperDailyRefreshTime !== undefined ? settings.bingWallpaperDailyRefreshTime : "09:00"
                bingWallpaperCurrentImagePath = settings.bingWallpaperCurrentImagePath !== undefined ? settings.bingWallpaperCurrentImagePath : ""
                bingWallpaperForceRefresh = settings.bingWallpaperForceRefresh !== undefined ? settings.bingWallpaperForceRefresh : false
                bingWallpaperForceRefreshTime = settings.bingWallpaperForceRefreshTime !== undefined ? settings.bingWallpaperForceRefreshTime : "09:00"
                bingWallpaperGalleryPath = settings.bingWallpaperGalleryPath !== undefined ? settings.bingWallpaperGalleryPath : ""
                bingDailyWallpaperEnabled = settings.bingDailyWallpaperEnabled !== undefined ? settings.bingDailyWallpaperEnabled : false
                ...
                interactiveTimeoutEnabled = settings.interactiveTimeoutEnabled !== undefined ? settings.interactiveTimeoutEnabled : true
    ...
    function saveSettings() {
        settingsFile.setText(JSON.stringify({
                                                ...
                                                "wallpaperLastPage": wallpaperLastPage,
                                                "wallpaperSortMode": wallpaperSortMode,
                                                "galleryColumns": galleryColumns,
                                                "galleryRows": galleryRows,
                                                "galleryScale": galleryScale,
                                                "galleryThumbnailRadius": galleryThumbnailRadius,
                                                ...
                                                "wallpaperTransitionDuration": wallpaperTransitionDuration,
                                                "useAwwwBackend": useAwwwBackend,
                                                "wallpaperFillMode": wallpaperFillMode,
                                                "bingWallpaperEnabled": bingWallpaperEnabled,
                                                "bingWallpaperNotifications": bingWallpaperNotifications,
                                                "bingWallpaperDeleteOld": bingWallpaperDeleteOld,
                                                "bingWallpaperDailyRefresh": bingWallpaperDailyRefresh,
                                                "bingWallpaperDailyRefreshTime": bingWallpaperDailyRefreshTime,
                                                "bingWallpaperCurrentImagePath": bingWallpaperCurrentImagePath,
                                                "bingWallpaperForceRefresh": bingWallpaperForceRefresh,
                                                "bingWallpaperForceRefreshTime": bingWallpaperForceRefreshTime,
                                                "bingWallpaperGalleryPath": bingWallpaperGalleryPath,
                                                "bingDailyWallpaperEnabled": bingDailyWallpaperEnabled,
                                                ...
                                                "interactiveTimeoutEnabled": interactiveTimeoutEnabled
                                            }, null, 2))
    }
    ...
    function setBingWallpaperEnabled(enabled) {
        bingWallpaperEnabled = enabled
        saveSettings()
    }

    function setBingWallpaperNotifications(enabled) {
        bingWallpaperNotifications = enabled
        saveSettings()
    }

    function setBingWallpaperDeleteOld(enabled) {
        bingWallpaperDeleteOld = enabled
        saveSettings()
    }

    function setBingWallpaperDailyRefresh(enabled) {
        bingWallpaperDailyRefresh = enabled
        saveSettings()
    }

    function setBingWallpaperDailyRefreshTime(time) {
        bingWallpaperDailyRefreshTime = time
        saveSettings()
    }

    function setBingWallpaperCurrentImagePath(path) {
        bingWallpaperCurrentImagePath = path
        saveSettings()
    }
    
    function setBingWallpaperForceRefresh(enabled) {
        bingWallpaperForceRefresh = enabled
        saveSettings()
    }
    
    function setBingWallpaperForceRefreshTime(time) {
        bingWallpaperForceRefreshTime = time
        saveSettings()
    }
    
    function setBingWallpaperGalleryPath(path) {
        bingWallpaperGalleryPath = path
        saveSettings()
    }
    ...
    function setInteractiveTimeoutEnabled(enabled) {
        interactiveTimeoutEnabled = enabled
        saveSettings()
    }
    ...
    FileView {
        ...
        path: `${Paths.strip(StandardPaths.writableLocation(StandardPaths.GenericStateLocation))}/EventHorizon/session.json`
        blockLoading: true
        blockWrites: true
        watchChanges: true
        onLoaded: {
    ...
    Process {
        ...
        command: ["sh", "-c", "CONFIG_DIR=\"" + _stateDir
            + "/EventHorizon\"; if [ -f \"$CONFIG_DIR/default-session.json\" ] && [ ! -f \"$CONFIG_DIR/session.json\" ]; then cp \"$CONFIG_DIR/default-session.json\" \"$CONFIG_DIR/session.json\" && echo 'copied'; else echo 'not_found'; fi"]
        running: false
        onExited: exitCode => {
            if (exitCode === 0) {
                settingsFile.reload()
