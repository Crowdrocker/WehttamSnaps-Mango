        ...
        Column {
            ...
            StyledRect {
                ...
                Column {
                    ...
                    EHToggle {
                        width: parent.width
                        text: "Enable interactive timeout"
                        description: "When disabled, prevents monitor from turning off due to inactivity"
                        checked: SessionData.interactiveTimeoutEnabled
                        onToggled: checked => SessionData.setInteractiveTimeoutEnabled(checked)
                    }
