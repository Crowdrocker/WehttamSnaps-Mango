...
Rectangle {
    ...
    implicitHeight: headerWrap.height + Theme.spacingS + audioColumn.implicitHeight + Theme.spacingM * 3
    clip:         true
    ...
    // ── Header (tap anywhere on title row — same as control-center pills) ─────
