...
Rectangle {
    ...
    /** Embedded under WeatherPill: share one outer card, no nested chrome */
    property bool embeddedInPill: false

    // Height driven only by visible content column — no circular ref
    implicitHeight: contentCol.implicitHeight + (embeddedInPill ? (Theme.spacingXS + 2) : Theme.spacingM * 2)
    radius:       embeddedInPill ? 0 : Theme.cornerRadius
    color:        embeddedInPill ? "transparent"
    ...
    border.color: embeddedInPill ? "transparent" : Qt.rgba(Theme.outline.r, Theme.outline.g, Theme.outline.b, 0.08)
    border.width: embeddedInPill ? 0 : 1
    ...
    Column {
        ...
        anchors {
            ...
            topMargin:   embeddedInPill ? (Theme.spacingXS + 2) : Theme.spacingM
        }
        ...
        Column {
            ...
            Item {
                width:  parent.width
                height: root.embeddedInPill ? 2 : 0
            }
