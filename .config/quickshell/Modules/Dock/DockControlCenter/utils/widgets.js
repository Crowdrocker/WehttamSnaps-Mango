...
function addWidget(widgetId) {
    ...
    // Volume mixer, media, and weather should always take full width (100 = full row = both left and right spots)
    var defaultWidth = (widgetId === "volumeMixer" || widgetId === "media" || widgetId === "weather") ? 100 : 50
    var widget = {
        "id": widgetId,
        "enabled": true,
        "width": defaultWidth
...
function toggleWidgetSize(index) {
    ...
    if (index >= 0 && index < widgets.length) {
        ...
        // Volume mixer, media, and weather always stay at full width (100 = both left and right spots)
        if (id === "volumeMixer" || id === "media" || id === "weather") {
