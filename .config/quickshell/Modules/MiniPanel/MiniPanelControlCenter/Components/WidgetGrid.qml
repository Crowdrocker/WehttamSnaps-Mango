                    ...
                    Item {
                        ...
                        height: {
                            ...
                            if (id === "volumeMixer") {
                                ...
                                return 36 + Theme.spacingXS + shown * 40 + Math.max(0, shown - 1) * Theme.spacingS
                                    + (oc + ic > 3 ? Theme.fontSizeSmall + 4 : 0)
                                    + Theme.spacingS
                            }
                            if (id === "worldClocks") {
                                if (widgetLoader.item && widgetLoader.item.implicitHeight > 0)
                            ...
                            if (id === "wifi" && NetworkService.networkStatus === "ethernet"
                                             && NetworkService.ethernetConnected)  return 68
                            if (id === "bluetooth" && BluetoothService.available
                                                   && !!(BluetoothService.adapter && BluetoothService.adapter.enabled)) return 68
                            return baseHeight
                        }
