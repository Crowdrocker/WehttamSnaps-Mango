...
Rectangle {
    ...
    radius: SettingsData.minipanelNoBackground ? 0 : Theme.widgetRadius * (widgetHeight / 30)
    color: {
    ...
    MouseArea {
        ...
        onClicked: {
            ...
            calendarPopup.panelScale = (SettingsData.miniPanelScale || 1.0)
            calendarPopup.barPosition = SettingsData.minipanelPosition || "top"
            calendarPopup.barThickness = (SettingsData.miniPanelHeight || 48) * (SettingsData.miniPanelScale || 1.0)
