                            ...
                            if (windowContextMenuLoader.item) {
                                ...
                                if (root.isBarVertical) {
                                    if (SettingsData.minipanelPosition === "left") {
                                        menuX = delegateItem.width + SettingsData.minipanelSpacing;
                                        menuY = relativeY - (windowContextMenuLoader.item.implicitHeight / 2);
                                    } else {
                                        menuX = -windowContextMenuLoader.item.implicitWidth - SettingsData.minipanelSpacing;
                                        menuY = relativeY - (windowContextMenuLoader.item.implicitHeight / 2);
                                    }
                                } else {
                                    menuX = relativeX - (windowContextMenuLoader.item.implicitWidth / 2);
                                    if (SettingsData.minipanelPosition === "top") {
                                        menuY = relativeY + delegateItem.height + SettingsData.minipanelSpacing - 7;
                                    } else {
                                        menuY = relativeY - windowContextMenuLoader.item.implicitHeight - SettingsData.minipanelSpacing - 7;
                                    }
                                }
