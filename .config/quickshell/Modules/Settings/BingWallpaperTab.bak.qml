    ...
    component StyledCombo: ComboBox {
        ...
        delegate: ItemDelegate {
            ...
            background: Rectangle {
                radius: 6
                color: highlighted
                    ? Qt.rgba(Theme.accentPrimary.r, Theme.accentPrimary.g, Theme.accentPrimary.b, 0.14)
                    : "transparent"
            }
            ...
            contentItem: StyledText {
                ...
                color: styledCombo.currentIndex === index ? Theme.accentPrimary : Theme.surfaceText
                leftPadding: 8
                anchors.verticalCenter: parent.verticalCenter
            }
        }
                ...
                Column {
                    ...
                    RowLayout {
                        ...
                        EHIcon {
                            ...
                            size: 20
                            color: isFetchingDaily ? Theme.accentPrimary : Theme.tertiary || "#4CAF50"
                        }
                ...
                Column {
                    ...
                    RowLayout {
                        ...
                        EHIcon {
                            ...
                            size: 20
                            color: isCheckingUpdates ? Theme.accentPrimary : Theme.primary
                        }
                ...
                Column {
                    ...
                    Row {
                        ...
                        EHIcon {
                            ...
                            size: Theme.iconSize
                            color: statusType === "success" ? (Theme.tertiary || "#4CAF50")
                                 : statusType === "error"   ? (Theme.error    || "#F44336")
                                 : Theme.accentPrimary
                        }
