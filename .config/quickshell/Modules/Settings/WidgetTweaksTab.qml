        ...
        Column {
            ...
            StyledRect {
                ...
                Column {
                    ...
                    EHSlider {
                        width: parent.width
                        height: 32
                        value: SettingsData.widgetRadius
                        minimum: 0
                        maximum: 48
                        unit: "px"
                        showValue: true
                        wheelEnabled: false
                        onSliderValueChanged: newValue => {
                            SettingsData.setWidgetCornerRadius(newValue)
                        }
                    }
                }
            }
            ...
            StyledRect {
                ...
                Column {
                    ...
                    EHToggle {
                        ...
                        description: "Only show workspaces that are in use — hidden workspaces appear/disappear automatically"
                        checked: SettingsData.dynamicWorkspaces
                        onToggled: checked => {
                                       return SettingsData.setDynamicWorkspaces(
                                           checked)
                                   }
                    }
            ...
            StyledRect {
                ...
                Column {
                    ...
                    EHToggle {
                        width: parent.width
                        text: "Scroll Long Media Titles"
                        description: "Scroll song titles when they exceed the widget width"
                        checked: SettingsData.mediaScrollEnabled
                        onToggled: checked => {
                            return SettingsData.setMediaScrollEnabled(checked)
                        }
                    }
                }
            }
