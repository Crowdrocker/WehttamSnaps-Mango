                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        const x = 50
                                        const y = 50 + (SettingsData.topBarHeight * SettingsData.topbarScale) + Theme.spacingS
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        const x = 50
                                        const y = Math.max(0, Screen.height - (parentModal ? parentModal.height : getDefaultHeight()) - 50 - (SettingsData.topBarHeight * SettingsData.topbarScale) - Theme.spacingS)
                                        SettingsData.setSettingsWindowX(x)
                                        SettingsData.setSettingsWindowY(y)
                                        if (parentModal) {
                                            parentModal.positioning = "custom"
