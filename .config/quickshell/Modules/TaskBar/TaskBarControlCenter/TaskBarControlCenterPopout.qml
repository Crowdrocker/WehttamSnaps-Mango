...
import qs.Services
import qs.Widgets
import qs.Modules.TaskBar.TaskBarControlCenter.Components
import qs.Modules.TaskBar.TaskBarControlCenter.Models
        ...
        Rectangle {
            ...
            width:  Math.min(root.spx(780),
                             Math.max(root.spx(560),
                                     menuColumn.implicitWidth + _hPad * 2)) + root.spx(8)
            height: Math.max(root.spx(220),
