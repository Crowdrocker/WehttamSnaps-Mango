...
Item {
    ...
    Component {
        ...
        Item {
            ...
            property real barThickness: spx(32)
            ...
            PanelWindow {
                ...
                function updatePosition() {
                    ...
                    // barThickness is already scaled (passed as barHeight * scale), use it directly
                    ...
                    if (menuRoot.barPosition === "top") {
                        ...
                        targetX = iconCenterX
                        targetY = screenY + scaledBarThickness + menuRoot.popupDistance + menuRoot.spx(15)
                    } else if (menuRoot.barPosition === "bottom") {
                        // Get icon's horizontal center
                        const globalPos = menuRoot.anchorItem.mapToGlobal(0, 0)
                        const iconCenterX = globalPos.x - screenX + menuRoot.anchorItem.width / 2
                        targetX = iconCenterX
                        targetY = screenY + screen.height - scaledBarThickness - menuRoot.popupDistance - menuRoot.spx(15)
                        ...
                        targetX = screenX + scaledBarThickness + menuRoot.popupDistance + menuRoot.spx(15)
                        targetY = iconCenterY
                    } else if (menuRoot.barPosition === "right") {
                        // Get icon's vertical center
                        const globalPos = menuRoot.anchorItem.mapToGlobal(0, 0)
                        const iconCenterY = globalPos.y - screenY + menuRoot.anchorItem.height / 2
                        targetX = screenX + screen.width - scaledBarThickness - menuRoot.popupDistance - menuRoot.spx(15)
                        targetY = iconCenterY
                    } else {
                        // Fallback
