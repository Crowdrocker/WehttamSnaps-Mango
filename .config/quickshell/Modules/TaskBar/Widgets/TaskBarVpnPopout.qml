    ...
    triggerX: {
        ...
        if (isBarVertical) {
            if (SettingsData.topBarPosition === "left") {
                return (SettingsData.topBarHeight * SettingsData.taskbarScale) + SettingsData.topBarSpacing + Theme.spacingXS
            } else {
                return screenWidth - (SettingsData.topBarHeight * SettingsData.taskbarScale) - SettingsData.topBarSpacing - Theme.spacingXS - 360
            }
        } else {
    ...
    triggerY: {
        if (isBarVertical) {
            ...
            if (SettingsData.topBarPosition === "top") {
                return (SettingsData.topBarHeight * SettingsData.taskbarScale) - 4 + SettingsData.topBarSpacing + Theme.spacingS
            } else {
                return (triggerScreen?.height ?? Screen.height) - (SettingsData.topBarHeight * SettingsData.taskbarScale) - SettingsData.topBarSpacing - Theme.spacingS - 4
            }
        }
    }
    triggerWidth: 70
