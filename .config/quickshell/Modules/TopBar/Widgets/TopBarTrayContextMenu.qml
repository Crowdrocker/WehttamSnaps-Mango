        ...
        Item {
            ...
            PanelWindow {
                ...
                function updatePosition() {
                    ...
                    const scale = (Appearance.combinedScale || 1) * (SettingsData.topbarScale || 1)
                    ...
                    if (menuRoot.barPosition === "top") {
                        ...
                        const iconCenterX = globalPos.x - (screen.x || 0) + menuRoot.anchorItem.width / 2
                        targetX = iconCenterX
                        targetY = scaledBarThickness + menuRoot.popupDistance + (15 * scale)
                    } else if (menuRoot.barPosition === "bottom") {
                        // Get icon's horizontal center
                        const globalPos = menuRoot.anchorItem.mapToGlobal(0, 0)
                        const iconCenterX = globalPos.x - (screen.x || 0) + menuRoot.anchorItem.width / 2
                        targetX = iconCenterX
                        targetY = screen.height - scaledBarThickness - menuRoot.popupDistance + (-15 * scale)
                    } else if (menuRoot.barPosition === "left") {
                        // Get icon's vertical center
                        const globalPos = menuRoot.anchorItem.mapToGlobal(0, 0)
                        const iconCenterY = globalPos.y - (screen.y || 0) + menuRoot.anchorItem.height / 2
                        targetX = scaledBarThickness + menuRoot.popupDistance + (15 * scale)
                        targetY = iconCenterY
                    } else if (menuRoot.barPosition === "right") {
                        // Get icon's vertical center
                        const globalPos = menuRoot.anchorItem.mapToGlobal(0, 0)
                        const iconCenterY = globalPos.y - (screen.y || 0) + menuRoot.anchorItem.height / 2
                        targetX = screen.width - scaledBarThickness - menuRoot.popupDistance + (-15 * scale)
                        targetY = iconCenterY
                    } else {
                        // Fallback
