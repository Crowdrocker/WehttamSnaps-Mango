...
Item {
    ...
    function resolveArtUrl(url) {
        ...
        // console.log("[AlbumArt] No valid art found for:", url);
    ...
    Connections {
        ...
        function onTrackArtUrlChanged() {
            if (activePlayer?.trackArtUrl) {
                lastValidArtUrl = resolveArtUrl(activePlayer.trackArtUrl)
            }
        }
    }

    Loader {
        active: activePlayer !== null && showAnimation
    ...
    EHCircularImage {
        ...
        onImageSourceChanged: {
            console.log("[AlbumArt] EHCircularImage imageSourceChanged:", imageSource, "status:", imageStatus)
    ...
    Binding {
        ...
        value: root.resolveArtUrl(root.artUrl) || root.lastValidArtUrl || ""
    }
}
