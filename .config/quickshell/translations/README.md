# Event Horizon Translations

This directory contains translation files for Event Horizon extracted from all qsTr() calls in the QML codebase.
...
```bash
cd /home/brandon/.config/quickshell/Event HorizonGit/translations
