...
CATEGORY_KEYWORDS = {
    ...
    "Event Horizon Bar": ["panel", "topbar", "statusbar"],
    ...
    for component in SEARCHABLE_COMPONENTS:
        ...
        for match in re.finditer(pattern, content):
            ...
            if visible_raw:
                ...
                elif "EHService.isConnected" in visible_raw:
                    condition_key = "EHConnected"
