...
sudo mount /dev/sdi1 /mnt/EXTRA1TB
sudo mount /dev/sdd1 /mnt/GAMEDRIVE
sudo mount -t ntfs-3g /dev/sdc1 /mnt/WettamSnapsMain
...
this is my fstab i originally had
...
# /dev/sdc1 -> WettamSnapsMain (4.5TB NTFS)
